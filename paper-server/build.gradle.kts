...
dependencies {
    implementation(project(":azurezero-api"))
...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            "Implementation-Title" to "AzureZero",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "AzureZero",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "AzureZero Team",
            "Brand-Id" to "azurezero:azurezero",
            "Brand-Name" to "AzureZero",
